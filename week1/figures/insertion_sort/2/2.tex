...
\begin{tikzpicture}[
    ...
    \node[array, right=0cm of n1, fill = lightgray] (n2) {5};
    \node[array, right=0cm of n2, fill = black, text = white] (n3) {4};
    \node[array, right=0cm of n3] (n4) {6};
    ...
    \draw [<->] (n2.south) to[in=-100, out=-80, looseness=2] (n3.south);
