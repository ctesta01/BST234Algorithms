...
\begin{tikzpicture}[
    ...
    \node[array, fill = lightgray] (n1) {5};
    \node[array, right=0cm of n1, fill = black, text = white] (n2) {2};
    \node[array, right=0cm of n2] (n3) {4};
    ...
    \draw [<->] (n1.south) to[in=-100, out=-80, looseness=2] (n2.south);
